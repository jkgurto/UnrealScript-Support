...
public final class UnrealScriptToolsOptionsPanelController extends OptionsPanelController {

    private UnrealScriptToolsPanel panel;
    ...
    private UnrealScriptToolsPanel getPanel() {
        if (panel == null) {
            panel = new UnrealScriptToolsPanel(this);
        }
        return panel;
    }
