...
public class UnrealScriptLanguageHierarchy extends LanguageHierarchy<UnrealScriptTokenId> {
   ...
   private static void init() {
       tokens = Arrays.<UnrealScriptTokenId>asList(new UnrealScriptTokenId[]{
                ...
                new UnrealScriptTokenId("FORMAL_COMMENT", "comment", UnrealScriptParserConstants.FORMAL_COMMENT),
                ...
                new UnrealScriptTokenId("CLASS", "keyword", UnrealScriptParserConstants.CLASS),
                ...
                new UnrealScriptTokenId("DELEGATE", "keyword", UnrealScriptParserConstants.DELEGATE),
                ...
                new UnrealScriptTokenId("LOCAL", "keyword", UnrealScriptParserConstants.LOCAL),
                new UnrealScriptTokenId("LOCALIZED", "keyword", UnrealScriptParserConstants.LOCALIZED),
                new UnrealScriptTokenId("NAME", "character", UnrealScriptParserConstants.NAME),
                ...
                new UnrealScriptTokenId("VAR", "keyword", UnrealScriptParserConstants.VAR),
                ...
                new UnrealScriptTokenId("CHARACTER_LITERAL", "keyword", UnrealScriptParserConstants.CHARACTER_LITERAL),
                ...
                new UnrealScriptTokenId("LPAREN", "operator", UnrealScriptParserConstants.LPAREN),
                new UnrealScriptTokenId("RPAREN", "operator", UnrealScriptParserConstants.RPAREN),
                new UnrealScriptTokenId("LBRACE", "operator", UnrealScriptParserConstants.LBRACE),
                new UnrealScriptTokenId("RBRACE", "operator", UnrealScriptParserConstants.RBRACE),
                new UnrealScriptTokenId("LBRACKET", "operator", UnrealScriptParserConstants.LBRACKET),
                new UnrealScriptTokenId("RBRACKET", "operator", UnrealScriptParserConstants.RBRACKET),
                new UnrealScriptTokenId("SEMICOLON", "operator", UnrealScriptParserConstants.SEMICOLON),
                new UnrealScriptTokenId("COMMA", "operator", UnrealScriptParserConstants.COMMA),
                new UnrealScriptTokenId("DOT", "operator", UnrealScriptParserConstants.DOT),
                ...
                new UnrealScriptTokenId("DEFAULT", "keyword", UnrealScriptParserConstants.DEFAULT),
                new UnrealScriptTokenId("IN_FORMAL_COMMENT", "comment", UnrealScriptParserConstants.IN_FORMAL_COMMENT),
                new UnrealScriptTokenId("IN_MULTI_LINE_COMMENT", "comment", UnrealScriptParserConstants.IN_MULTI_LINE_COMMENT)*/
               });
